...
This file performs the MSP post-hoc method (and all other methods adopted for EoMT) on the Anomaly Validation Datasest used in evalAnomaly.py and evalAnomaly_eomt.py (the dataset is [here](https://drive.google.com/file/d/1zcayoIIJztxKuHOIjmSjGoQBDy4RdETr/view?usp=drive_link)). The key feature here is the implementation of the Temperature Scaling, a calibration technique used especially for semantic segmentation tasks.
